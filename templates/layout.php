...
<body <?= (basename($_SERVER['PHP_SELF']) === 'guest.php') ? ' class="body-background" ' : '' ?>>
    ...
    <div class="page-wrapper">
        <div class="container <?= (basename($_SERVER['PHP_SELF']) === 'guest.php') ? '' : ' container--with-sidebar ' ?>">
            <header class="main-header">
                <a href="<?= (empty($userData)) ? '/guest.php' : '/' ?>">
            ...
            <div class="content">
                <?php if (basename($_SERVER['PHP_SELF']) !== 'guest.php') { ?>
                                ...
                                <ul class="main-navigation__list">
                                    <?php foreach ($projects as $key => $value) { ?>
                                        <li class="main-navigation__list-item <?= (isset($_GET['id']) && $_GET['id'] === $value['id']) ? ' main-navigation__list-item--active ' : '' ?>">
                                            <a class="main-navigation__list-item-link" href="<?= '/index.php?id=' . $value['id'] ?>"> <?= $value['project_name'] ?></a>
                                            <span class="main-navigation__list-item-count"><?= countTasks(array_column($projectsId, 'project_id'), $value['id']) ?></span>
                                        </li>
                                    <?php } ?>
                                </ul>
                            </nav>
    ...
    <footer class="main-footer">
        <div class="container">
            ...
            <?= (!empty($userData)) ? '<a class="main-footer__button button button--plus" href="/add.php">Добавить задачу</a>' : '' ?>
